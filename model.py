...
for folder in ['data','extra_track1','recoverings','slow','recov1','slow_part' ]: # ,'recov1','bridge', 'slow','slow_part','extra_track1','recoverings','recov2', 'recov3', 'recov4' #'juanma',,'slow_part' 
