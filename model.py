...
for folder in ['data','extra_track1','recoverings','slow','slow_part','recov2', 'recov3', 'recov4']: # 'slow','slow_part','extra_track1','recoverings','recov2', 'recov3', 'recov4' #'juanma',,'slow_part' 
